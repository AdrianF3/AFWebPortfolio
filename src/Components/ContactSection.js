...
export default function ContactSection() {
  return (
    <section className="text-gray-600 body-font relative p-4">
      <div className="container px-5 py-24 mx-auto border-cyan-900 border-4 bg-cyan-900/30 rounded-xl">
        ...
        <div className="flex flex-col text-center w-full mb-8">
          ...
          <div>
            <button
              className='p-3 bg-cyan-700 rounded-xl text-white text-xl text-wider'
            >
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center text-xl">  
          <div>
